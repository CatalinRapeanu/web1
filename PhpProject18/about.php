...
<html lang="en">
    ...
    <body>
        <!--<div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/ro_RO/sdk.js#xfbml=1&version=v17.0" nonce="ZRSsC5Sl"></script>
        <div id="fb-root"></div>
        ...
        <div class="fb-share-button container m-auto" style="margin-left:400px;" 
        data-href="https://www.uaic.ro" 
